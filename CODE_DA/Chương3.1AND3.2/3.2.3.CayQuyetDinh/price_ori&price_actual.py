...
X_test_sorted = X_test.sort_values(by='price_ori')
...
print(f"Độ sâu của cây quyết định: {tree_depth}")
...
# Cấu hình biểu đồ
plt.title("Decision Tree Regression: Mối quan hệ giữa price_ori và price_actual", fontsize=14)
