...
df = data[['total_sold', 'favorite']].dropna()

# Tạo và vẽ đường hồi quy tuyến tính
X = df[['total_sold']]  # Biến độc lập (giá gốc)
y = df['favorite']  # Biến phụ thuộc (giá thực tế)
...
plt.title('Linear Regression: total_sold vs favorite (Train/Test Split)')
