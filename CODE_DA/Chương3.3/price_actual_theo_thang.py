...
monthly_avg_price = data.groupby(['month', 'category1'])['price_actual'].mean().unstack(fill_value=0)
...
plt.title('Giá bán thực tế của các loại sản phẩm (category1) theo tháng', fontsize=16)
plt.xlabel('Tháng', fontsize=14)
plt.ylabel('Giá bán thực tế', fontsize=14)
