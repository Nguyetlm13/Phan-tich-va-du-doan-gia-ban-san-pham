...
monthly_avg_price = data.groupby(['month', 'category1'])['favorite'].mean().unstack(fill_value=0)
...
plt.title('số lượt thích trung bình của các loại sản phẩm (category1) theo tháng', fontsize=16)
plt.xlabel('Tháng', fontsize=14)
plt.ylabel('Lượt thích trung bình', fontsize=14)
