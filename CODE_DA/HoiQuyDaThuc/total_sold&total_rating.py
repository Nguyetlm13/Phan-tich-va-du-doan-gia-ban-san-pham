...
y = data['total_rating'].values  # Biến phụ thuộc (giá thực tế)
...
plt.title('Hồi quy đa thức giữa total_sold và total_rating', fontsize=14)
plt.xlabel('total_sold (số lượt bán)', fontsize=12)
plt.ylabel('total_rating (Số lượt đánh giá)', fontsize=12)
